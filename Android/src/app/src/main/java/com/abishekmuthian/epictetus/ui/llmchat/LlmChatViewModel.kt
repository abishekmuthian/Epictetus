...
import com.abishekmuthian.epictetus.data.ConfigKeys
import com.abishekmuthian.epictetus.data.Model
import com.abishekmuthian.epictetus.data.Task
import com.abishekmuthian.epictetus.ui.common.chat.ChatMessageAudioClip
import com.abishekmuthian.epictetus.ui.common.chat.ChatMessageBenchmarkLlmResult
import com.abishekmuthian.epictetus.ui.common.chat.ChatMessageError
import com.abishekmuthian.epictetus.ui.common.chat.ChatMessageLoading
import com.abishekmuthian.epictetus.ui.common.chat.ChatMessageText
import com.abishekmuthian.epictetus.ui.common.chat.ChatMessageType
import com.abishekmuthian.epictetus.ui.common.chat.ChatMessageWarning
import com.abishekmuthian.epictetus.ui.common.chat.ChatSide
import com.abishekmuthian.epictetus.ui.common.chat.ChatViewModel
import com.abishekmuthian.epictetus.ui.common.chat.Stat
...
open class LlmChatViewModelBase() : ChatViewModel() {
  ...
  fun generateResponse(
    ...
    viewModelScope.launch(Dispatchers.Default) {
      // Reset conversation before each new question to start fresh session
      // This prevents context window overflow - without reset, conversation history accumulates
      // and after 2-3 exchanges the model hits token limits, producing only single-word responses
      // Fresh sessions ensure consistent response quality for each philosophical question
      try {
        ...
        Log.d(TAG, "Failed to reset conversation before new question: ${e.message}")
      }
        ...
        try {
          val supportImage =
            model.llmSupportImage &&
              task.id == com.abishekmuthian.epictetus.data.BuiltInTaskId.LLM_ASK_IMAGE
          val supportAudio =
            model.llmSupportAudio &&
              task.id == com.abishekmuthian.epictetus.data.BuiltInTaskId.LLM_ASK_AUDIO
          LlmChatModelHelper.resetConversation(
            model = model,
            supportImage = supportImage,
            supportAudio = supportAudio,
