...
data class Model(
   ...
   * - `com.abishekmuthian.epictetus` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/com.abishekmuthian.epictetus/files/my_model/local_dir/
   *
