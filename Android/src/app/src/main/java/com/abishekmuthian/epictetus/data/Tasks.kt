...
package com.abishekmuthian.epictetus.data
 ...
 *
 * To register a custom task, see [com.abishekmuthian.epictetus.customtasks.common.CustomTask].
 */
data class Task(
  /**
   * The id of the task.
...
object BuiltInTaskId {
  ...
  const val LLM_VOICE_TO_ACTION = "llm_voice_to_action"
  const val LLM_GEMMAS_GARDEN = "llm_gemmas_garden"
}
